...
- [x] **CMS-02**: Clicking a map pin opens a popup dialog with an image carousel (prev/next navigation)
- [x] **CMS-03**: All hardcoded project data removed from source code and replaced with Keystatic-managed content
