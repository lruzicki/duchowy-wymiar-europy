...
import { getLocationBySlug, selectLocationLocalizedText } from '@/lib/locations'
...
function LocationPage() {
  ...
  const locationName = selectLocationLocalizedText(location.name, locale)
  const locationCity = selectLocationLocalizedText(location.city, locale)
  const locationCountry = selectLocationLocalizedText(location.country, locale)
  const locationDate = selectLocationLocalizedText(location.date, locale)
  const locationSummary = selectLocationLocalizedText(location.summary, locale)
